          ...
          <div class="carousel-item active">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="<?php echo e(asset('ui/frontend/images/slider-img.png')); ?>" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="<?php echo e(asset('ui/frontend/images/p1.png')); ?>" alt="">
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo e(asset('ui/frontend/images/p3.png')); ?>" alt="">
              <a href="" class="add_cart_btn">
                <span>
                  Add To Cart
                </span>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo e(asset('ui/frontend/images/p4.png')); ?>" alt="">
              <a href="" class="add_cart_btn">
                <span>
                  Add To Cart
                </span>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo e(asset('ui/frontend/images/p5.png')); ?>" alt="">
              <a href="" class="add_cart_btn">
                <span>
                  Add To Cart
                </span>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo e(asset('ui/frontend/images/p6.png')); ?>" alt="">
              <a href="" class="add_cart_btn">
                <span>
                  Add To Cart
                </span>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo e(asset('ui/frontend/images/p7.png')); ?>" alt="">
              <a href="" class="add_cart_btn">
                <span>
                  Add To Cart
                </span>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo e(asset('ui/frontend/images/p9.png')); ?>" alt="">
              <a href="" class="add_cart_btn">
                <span>
                  Add To Cart
                </span>
...
<?php endif; ?>
<?php /**PATH C:\Software\wamp64\www\seip-laravel-b8-main\resources\views/frontend/index.blade.php ENDPATH**/ ?>