        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <a href="<?php echo e(route('categories.pdf')); ?>">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex">
                        <a class="btn btn-sm btn-outline-info" href="<?php echo e(route('categories.show', $category->id)); ?>">Show</a>

                        <a class="btn btn-sm btn-outline-info" href="<?php echo e(route('categories.edit', $category->id)); ?>">Edit</a>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH C:\Software\wamp64\www\seip-laravel-b8-main\resources\views/categories/index.blade.php ENDPATH**/ ?>